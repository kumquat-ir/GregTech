...
public class RecipeMaps {
    ...
    @ZenProperty
    public static final RecipeMapAssemblyLine<AssemblyLineRecipeBuilder> ASSEMBLY_LINE_RECIPES = new RecipeMapAssemblyLine<>("assembly_line", 4, 16, 1, 1, 0, 4, 0, 0, new AssemblyLineRecipeBuilder(), false);
    ...
    @ZenProperty
    public static final RecipeMap<ScannerRecipeBuilder> SCANNER_RECIPES = new RecipeMap<>("scanner", 0, 2, 1, 1, 0, 1, 0, 0, new ScannerRecipeBuilder().EUt(30), false)
            .setSlotOverlay(false, false, GuiTextures.DATA_ORB_OVERLAY)
